...
const EVAL_PROMPT = `You are a rigorous OCIO education evaluator. Score the user's answer against the question and model answer.

Scoring rubric (1-5):
5 = Correct, complete, uses OCIO or institutional-investing reasoning, decision-useful framing, clear and professional
