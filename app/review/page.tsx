...
function ReviewCardTile({
  ...
  const aiPrompt =
    ...
    `Prompt: "${card.front}"\nAnswer: "${card.back}"\n\n` +
    `Help me understand this concept deeply in an OCIO and institutional-investing context.`;
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#D0C8C0]">Â·</span>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[#D0C8C0] ml-1">Â·</span>
