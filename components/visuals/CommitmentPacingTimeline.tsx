 ...
 * Teaches: Why maintaining a PE target allocation requires committing every year â€”
 ...
 * Pure Tailwind â€” no charting library.
 */
export default function CommitmentPacingTimeline() {
  // Each row is one vintage year. Cells describe the phase of that fund in years 1â€“10.
  ...
  return (
    <div className="my-3 rounded-xl border border-[#E8DDD4] bg-[#FBF7F3] p-4">
      ...
      <p className="text-[11px] text-[#9A918A] mb-4 italic">
        At any point in time, a PE programme has vintages in all three lifecycle phases simultaneously â€” calls from recent vintages, distributions from older ones. Stopping commitments for even one year creates a gap in future funded exposure.
      </p>
      ...
      <div className="overflow-x-auto">
        <div className="min-w-[540px]">
          ...
          {/* "Now" marker â€” column 2025 is index 5 (0-based) */}
      ...
      <div className="mt-3 rounded-lg bg-[#2294BD]/10 border border-[#2294BD]/30 px-3 py-2">
        <p className="text-[10px] text-[#404040]">
          <span className="font-semibold">What to notice:</span> In 2024, three vintages (2021â€“2023) are simultaneously in the capital-call phase. A programme that committed nothing in 2022â€“2023 would have fewer active draws â€” and lower funded NAV â€” than a pacing model would predict. Gaps in commitment create gaps in future exposure.
        </p>
      </div>
    </div>
  );
