 ...
 *          "concentrated" looks like â€” and why it matters for programme resilience.
...
export default function VintageDiversification() {
  // Illustrative programme â€” concentrated in 2020â€“2021
  const vintages = [
  ...
  const otherDimensions = [
    {
      ...
      risk: "Over 25â€“30% of programme with a single GP",
    ...
    {
      label: "Geography",
      risk: "North Americaâ€“only concentration; missing European / Asian cycles",
  ...
  return (
    <div className="my-3 rounded-xl border border-[#E8DDD4] bg-[#FBF7F3] p-4">
      ...
      <p className="text-[11px] text-[#9A918A] mb-3 italic">
        The 2020â€“2021 vintages represent 49% of total committed capital â€” nearly half the programme entered a single macro and valuation environment.
      </p>
